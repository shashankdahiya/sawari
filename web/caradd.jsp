            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="section-title  text-center">
                        ...
                        <p>Add new Employee and details.</p>
                    </div>
                </div>
                <!-- Page Title End -->
            </div>
                		...
                		<div class="login-form">
                			<h3>Add Car</h3>
								...
								<div class="name">
									<div class="row">
										<div class="col-md-6">
                                                                                    <input type="text" name="rc" placeholder="mp09cc2586">
										</div>
										<div class="col-md-6">
                                                                ...
                                                                <div class="username">
                                                                    <input type="text" name="year" placeholder="2017">
								</div>
								<div class="username">
                                                                <input type="text" name="category" placeholder="eco or suv or sedan">    
								</div>
                                                            <div class="username">
                                                                <input type="text" name="status" placeholder="available or under maintenance">
                                                                
								</div>
                                                                        
								<div class="log-btn">
									<button type="submit"><i class="fa fa-check-square"></i> <b>Add Car</b></button>
								</div>
							</form>
                		</div>
