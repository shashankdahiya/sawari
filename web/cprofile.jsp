        ...
        <div class="container">
            <div class="row">
                ...
                <!-- Section Title End -->
                    ...
                    <% List<User> bb1 = (ArrayList<User>)request.getAttribute("fetchcustomer"); %>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-6 text-center">
                    <div class="single-pricing-table">
                        <h3><i>Licence: </i><%out.println(userName); %></h3>
                        <h2><i>Name: </i><%out.println(b1.getName()); %></h2>
                        <h5><i>Email: </i><%out.println(b1.getEmail()); %></h5>
                        <h5><i>Phone: </i><%out.println(b1.getPhone());%></h5>
                        <h5><i>Membership: </i><%out.println(b1.getMembershipid());%></h5>
                        <% if(b1.getMembershipid().equals("yes")){ %>
                        <ul class="package-list">
                            <li> <B>YES! YOU ARE MEMBER. PAY EXTRA 1000 & ENJOY BENEFITS<BR></b></li>
                            <li>YOU GET <b>25%</b> OFF ON EVERY RIDE</li>
                            <li>FULL INSURANCE INCLUDED</li>
                            <li>FREE VEHICLE DELIVERY</li>
                            <li>FREE RIDE KILOMETERS</li>
                        </ul><%}else{%><ul class="package-list">
                            <li>SAY <B>YES</B> TO MEMBERSHIP & PAY 1000 EXTRA ON FIRST RIDE</li>
                            <li>YOU GET :<BR><LI>
                            <LI><b>25%</b> OFF ON EVERY RIDE</li>
                            <li>FULL INSURANCE INCLUDED</li>
                            <li>FREE VEHICLE DELIVERY</li>
                            <li>FREE RIDE KILOMETERS</li>
                        <%session.setAttribute("licence", userName);%>
                            <a href="turnmembership" class="readmore-btn">TURN ON MEMBERSHIP</a>
                    </ul>
                        <%      }%>
                    </div>
                </div>
