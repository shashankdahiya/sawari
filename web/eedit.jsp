                	...
                	<div class="login-page-content">
                		<div class="login-form">
                			<h3>Edit Details</h3>
                                        ...
                                        <form action="Eedit" method="post">
                                            
                                            <input type="text" style="display:none" name="eid" value="<%out.println(eid);%>" >
                                            <input type="text" name="name" value="<%out.println(name);%>" >
                                            <input type="text"  name="phone" value="<%out.println(phone);%>" >
                                            
                                            <input type="text" name="email" value="<%out.println(email);%>" >
                                            <input type="text" name="address" value="<%out.println(address);%>" >
                                            <input type="text" name="position" value="<%out.println(position);%>" >
                                            <div class="log-btn">
