...
for(Cookie cookie : cookies){
	if(cookie.getName().equals("eid")) userName = cookie.getValue();
                                ...
                                <ul><%session.setAttribute("eid", userName);%>
                                    ...
                                    <li ><a href="Ebookings">Bookings</a></li>
                                               ...
                                               <div class="col-2  "><%out.println(b.getName());%></div>
                                                ...
                                                <%
                                                        if(b.getStatus().equals("available")){
                                                            %>
                                                            <form class="col-2"  action="setum"  method="post">  
                                                                <input type="hidden" name="rc" value="<%out.print(b.getRc());%>" > 
                                                                <input type="submit" value="-> Maintenance">
                                                                
                                                            </form>
                                                
                                                <% }else{if(b.getStatus().equals("under maintenance")){
                                                        %>
                                                
                                                        <form class="col-2" action="seta"  method="post">  
                                                                <input type="hidden" name="rc" value="<%out.print(b.getRc());%>" > 
