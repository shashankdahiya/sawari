<%-- 
    ...
    Created on : 20 Feb, 2019, 2:10:32 PM
    Author     : root
--%>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 text-center">
                        <i class="fa fa-mobile"></i> +91 1112223333                    </div>
                    <!--== Single HeaderTop End ==-->
                		...
                		<div class="login-form">
                			<h3>Sign Up</h3>
								...
								<div class="name">
									<div class="row">
										<div class="col-md-6">
                                                                                    <input type="text" name="licence" placeholder="10 digit licence number">
										</div>
										<div class="col-md-6">
								...
								<div class="password">
									<input type="password" placeholder="Password">
                                                            ...
                                                            <div class="username">
                                                                <input type="radio" name="membershipid" value="yes">yes to Membership
                                                                <div class="username">Membership will give you 25% on every booking on cost of 1500/- on first ride.</div>
                                                                <br>
                                                                <input type="radio" name="membershipid" value="no">no to Membership<br>
								</div>
								<div class="log-btn">
