<%-- 
    Document   : login
    Created on : 28 Feb, 2019, 7:00:01 PM
    Author     : intel
--%>
...
<body class="loader-active">
    ...
    <section id="lgoin-page-wrap" class="section-padding">
        <div class="container">
                	...
                	<div class="login-page-content">
                			...
                			<h3>Welcome Back!</h3>
                                        <form action="Login" method="post">
                                                            <div class="username">
                                                                <div class="log-btn">Login As:</div>
                                                                <select name="type">
                                                                ...
                                                                <div class="username">
                                                                    <input type="text" name="pk" placeholder="Licence Number/ EID/ AdminID">
								</div>
								<div class="password">
            ...
            <div class="row">
                    <div class="align-center login-menu">
