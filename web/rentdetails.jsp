                	...
                	<div class="login-page-content">
                		<div class="login-form">
                                 ...
                                 <form class="row" action="search">
                                            <input class="rounded col-lg-3 col-xl-3" type="search" name="licence" placeholder="Search By Customer ID">
                                            <a><input class="rounded col-lg-1 col-xl-1" type="submit" value="🔍"></a>
                                        </form>
                                        ...
                                        <table class="table table-hover table-striped">
                                            <tr>
                                                <th>Rent ID</th>
                                                    ...
                                                    <th>Ride Start's on</th>
                                                        <th>Ride Kilometer</th>
                                                        <th>Ride End's on</th>
                                                        <th>Ride Status</th>
                                                    <th>Customer ID</th>
                                                    <th>Bill ID</th>
                                            ...
                                            %>
                                            <tr>
                                                <td><%out.println(b.getRentid());%></td>
                                                <td><%out.println(b.getRc());%></td>
                                                <td><%out.println(b.getLocation());%></td>
                                                <td><%out.println(b.getStart());%></td>
                                                <td><%out.println(b.getKm());%></td>
                                                <td><%out.println(b.getEnd());%></td>
                                                <td><%out.println(b.getRentstatus());%></td>
                                                <td><%out.println(b.getLicence());%></td>
                                                <td><%out.println(b.getBillid());%></td>
                                            </tr>
                                            <%}%>
                                        </table>
