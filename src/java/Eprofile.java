...
@WebServlet(urlPatterns = {"/Eprofile"})
public class Eprofile extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       Object userid = session.getAttribute("eid");    
                            String eid = userid.toString();
       RegisterDao rd= new RegisterDao();
       List<User> fetchemployee = rd.fetchemployee(eid);
